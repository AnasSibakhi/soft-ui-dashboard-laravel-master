...
<div class="container-fluid py-4">
    <div class="card">
        <div class="card-header pb-0 px-3">
            <h6 class="mb-0">Create New Video</h6>
        </div>
        <div class="card-body pt-4 p-3">
            <form action="{{ route('videos.index') }}" method="POST" autocomplete="off">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3">
                        <label for="link" class="form-control-label">Video Link (e.g. YouTube or Vimeo)</label>
                        <input class="form-control" type="url" id="link" name="link" placeholder="Enter video link" value="{{ old('link') }}" required>
                        @if ($errors->has('link'))
